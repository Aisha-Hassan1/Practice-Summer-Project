...
function StoresVehiclesData(NumberOfStores,NumberOfVehicles,Cars,Stores)
{
for(let i=0;i<NumberOfStores;i++)
{
    let obj={
        ...
        market:"Store",
        vehicles:[],
        "Total Orders":Stores[i].total,
        "Icy Orders":Stores[i].icy,
        "Not Icy Orders":Stores[i].notIcy,
...
console.log(sessionStorage.StoresVehiclesData)
console.log(arrData);
}
StoresVehiclesData(JSON.parse(sessionStorage.counterStores),JSON.parse(sessionStorage.counterVehicles),JSON.parse(sessionStorage.Vehicles),JSON.parse(sessionStorage.Stores));
